...
<html>
    ...
    <body>
        ...
        <table class="table table-striped">
            ...
            <tbody>
            <!-- show self questions from database-->
            <?php
                $query=mysqli_query($conn,"select * from selfuploadquestion");
                while($row=mysqli_fetch_array($query)){
                    ...
                    if($row['privacy']=='1'){
                        ...
                        <td width='420' name='td2' ><a href='uploaddetail.php?id=$newID' class='black'><b>".$newcontent."</b></a></td>
