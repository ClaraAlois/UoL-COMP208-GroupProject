	...
	<body>
		<div class="register">	
			...
			<div class="term-condition" style="margin-left:4%; margin-right:-1%; text-align: justify;margin-bottom: 20px;">1. Overview of the software: </br>
				...
				c.	At the left hand side of the website, there is a black navigation bar including dashboard, questions, calendar, contact and file 
				manager. Click the questions, and you can see a menu including self-upload questions, university questions, upload questions and bookmark 
				questions.</br>
				</br>
				...
				question. You can also self-define a tag for the question, which makes it easier to be retrieved later. The question can 
				...
				will appear in the Rating box.</br>
				</br>
				5)	Bookmark questions:</br>
				</br>
				a.	You can see your own bookmark questions in this interface.</br>
				b.	Tick to add questions to bookmark questions.</br>
				c.	You can also sort the bookmark by date or accuracy rate.</br>
				</br>
				6)	Calendar:</br>
				</br>
				You can use it to plan your study.</br>
				</br>
				7)	Contact:</br>
				</br>
				You can see your friends’ information in Contact.</br>
				</br>
				8)	File manager:</br>
				</br>
