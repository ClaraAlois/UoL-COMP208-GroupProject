...
$rightanswer=$row2['rAnswer'];
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST") {
      $a=$_GET['id'];
      $user=$_SESSION['user'];
      $answer = mysqli_real_escape_string($conn,$_POST['wanswer']);
      $result1=mysqli_query($conn,"insert into wronganswer(answer,administratorID,uniQuestionID,user)
        values('$answer','000000','$a','$user')");
        $rightanswer4=$_GET['correctAnswer'];

      if(strstr($answer,'not')==false){
     $curl = curl_init();

curl_setopt_array($curl, array(
    CURLOPT_URL => "https://rxnlp-core.p.rapidapi.com/computeSimilarity",
    ...
    CURLOPT_POSTFIELDS => "{  \"text1\": \"$answer\",  \"text2\": \"$rightanswer4\",   \"clean\": \"true\" }",
    CURLOPT_HTTPHEADER => array(
        "accept: application/json",
        "content-type: application/json",
        "x-rapidapi-host: rxnlp-core.p.rapidapi.com",
        "x-rapidapi-key: 48bc84cdb8mshdf8440e22082c30p10390ejsn0e044589692f"
    ),
));
...
if ($err) {
    ...
    $result3=mysqli_query($conn,"update universityquestion set accuracy='$value1' where questionID='$a'");
    echo $value1;
    Header("Location: rate2.php?accuracy=$value1&id=$a"); 
}
...
<body>
    ...
    <p style="position:absolute; left:305px; top:80px; font-size: x-large; width: 300px;" class="sansserif"><b>Start
            solving the question</b></p>
    <a href="schoolpage.php"><img alt="h" src="house1.png" width="30px" height="30px"
            style="position:absolute; left:300px; top:112px;"></a>
    ...
    <img alt="h" src="1.png" width="30px" height="30px" style="position:absolute; left:1120px; top:120px; "
        onclick="msg4()">
    <img alt="h" src="2.png" width="30px" height="30px" style="position:absolute; left:1155px; top:120px; "
        onclick="msg1()">

    <div class="wrap1"></div>
    <p style="position:absolute; left:300px; top:20px; color:gray;" class="sansserif">Welcome to Drops!</p>
    <img alt="h" src="8.png" width="30px" height="30px" style="position:absolute; left:1100px; top:10px; "
        onclick="msg2()"></a>
    <img alt="h" src="9.png" width="30px" height="30px" style="position:absolute; left:1140px; top:10px; "
        onclick="msg3()"></a>
    <a href="homepage.php"><img alt="h" src="10.png" width="48px" height="48px"
            style="position:absolute; left:1180px; top:4px; "></a>
        ...
        <div class="nav">
            <ul>
                ...
                <li class="list">
                    ...
                    <div class="hide">
                        <h5><a href="mypage.php" class="grey"><img alt="h" src="14.png" width="16px" height="16px"> SELF
                                QUESTIONS</a></h5>
                        <h5><a href="schoolpage.php" class="grey"><img alt="h" src="14.png" width="16px" height="16px">
                                UNIVERSITY QUESTIONS</a></h5>
                        <h5><a href="bookmark.php" class="grey"><img alt="h" src="14.png" width="16px" height="16px">
                                BOOKMARK QUESTIONS</a></h5>
                        <h5><a href="upload.php" class="grey"><img alt="h" src="14.png" width="16px" height="16px">
                                UPLOAD QUESTIONS</a></h5>
                    </div>
                </li>
                <li class="list1">
   ...
   <div class="wrap2" >
        ...
        <form action="rate.php?id=<?php echo $a ?>&correctAnswer=<?php echo $rightanswer ?>" method="post" autocomplete="off" class="sansserif" >
            <b>Question：</b><br><textarea name="question" rows="2" cols="54" readonly style="resize: none;width:860px; resize: none;background-color:#F95555 ;padding:20px;font-size:x-large;font-weight:bolder;wordwrap:break-word;" ><?=$content;?></textarea><br><br>
            <b>Give your answer：</b><br><textarea name="wanswer" placeholder="Type here.." rows="8" cols="130" style="resize: none;width:900px;" autofocus required maxlength=300 ></textarea><br><br>
            <input type="submit" class="button" value="SUBMIT" style="position:absolute; left:780px; top:auto;z-index: 1;"><br>
            <b>Rate：</b><br><textarea name="rate" rows="2" cols="130" readonly style="resize: none;width:900px;"></textarea><br><br>
...
<script>
 ...
 <!--js:control correct answer when to show-->
